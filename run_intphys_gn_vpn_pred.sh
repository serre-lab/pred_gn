...
#SBATCH --mem=120G
#SBATCH -n 30
#SBATCH -J IP_GN_PRED_Rep_Sat_18ts
#SBATCH -p gpu 
#SBATCH -o GN_IP_VPN_PRED_18ts_Rep_Sat_L1.out
#SBATCH -e GN_IP_VPN_PRED_18ts_Rep_Sat_L1.err
...
EXP_NAME="GN_IntPhys_VPN_PRED_18ts_Rep_Sat_L1"
