...
# downsampling resize with: Pooling (A) and a Strided 3d Conv (B)
_C.RESNET.SHORTCUT_TYPE = 'B'
...
_C.PREDICTIVE = CfgNode()

_C.PREDICTIVE.ENABLE = False

_C.PREDICTIVE.CPC = False

_C.PREDICTIVE.CPC_FAN_OUT = 32

_C.PREDICTIVE.CPC_STEPS = [2,4,8]
...
_C.HMDB.ANNOTATION_PATH = '/users/azerroug/data/azerroug/HMDB51/hmdb51_1.json'

_C.HMDB.OUT_SAMPLE_RATE = 30
...
# Eigenvalues for PCA jittering. Note PCA is RGB based.
_C.HMDB.TRAIN_PCA_EIGVAL = [0.225, 0.224, 0.229]

# Eigenvectors for PCA jittering.
_C.HMDB.TRAIN_PCA_EIGVEC = [
    [-0.5675, 0.7192, 0.4009],
    [-0.5808, -0.0045, -0.8140],
    [-0.5836, -0.6948, 0.4203],
]
